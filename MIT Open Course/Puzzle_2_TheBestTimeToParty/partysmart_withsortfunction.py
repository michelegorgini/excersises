# Michele: I used the sort function with 2 keys
...
def bestTimeToPartySmart(schedule):
    ...
    #sortlist(times)   # without sort function
    # print('='*20)
    # print(times)

    sorted_list = sorted(times, key=sorter)
    print('+'*20)
    print(sorted_list)

    ##    print times

    maxcount, time = chooseTime(sorted_list)
...
#         #for i in range(ismall+1, len(tlist)):  I think that with this range I can avoid some loop checks
